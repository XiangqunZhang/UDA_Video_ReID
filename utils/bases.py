...
class BaseDataset(object):
    ...
    def get_imagedata_info(self, data):
        # pids, cloth_ids, cams = [], [], []
        pids, cams = [], []
        # for _, pid, cloth_id, camid in data:
...
#         num_train_pids, num_train_cloth_ids, num_train_imgs, num_train_cams = self.get_imagedata_info(train)
#         num_query_pids, num_query_cloth_ids, num_query_imgs, num_query_cams = self.get_imagedata_info(query)
#         num_gallery_pids, num_gallery_cloth_ids, num_gallery_imgs, num_gallery_cams = self.get_imagedata_info(gallery)
#
#         print("Dataset statistics:")
#         print("  ----------------------------------------")
#         print("  subset   | # ids | # cloth_ids | # images | # cameras")
#         print("  ----------------------------------------")
#         print("  train    | {:5d} | {:5d} | {:8d} | {:9d}".format(num_train_pids, num_train_cloth_ids, num_train_imgs, num_train_cams))
#         print("  query    | {:5d} | {:5d} | {:8d} | {:9d}".format(num_query_pids, num_query_cloth_ids, num_query_imgs, num_query_cams))
#         print("  gallery  | {:5d} | {:5d} | {:8d} | {:9d}".format(num_gallery_pids, num_gallery_cloth_ids, num_gallery_imgs, num_gallery_cams))
#         print("  ----------------------------------------")
...
class BaseImageDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery):
        ...
        print("  ----------------------------------------")
        print("  train    | {:5d} | {:5d} | {:8d} ".format(num_train_pids, num_train_imgs, num_train_cams))
        print("  query    | {:5d} | {:5d} | {:8d} ".format(num_query_pids, num_query_imgs, num_query_cams))
        print("  gallery  | {:5d} | {:5d} | {:8d} ".format(num_gallery_pids, num_gallery_imgs, num_gallery_cams))
        print("  ----------------------------------------")
