...
class SVReID_CC(object):
    ...
    def __init__(self, root='/data/datasets/', sampling_step=64, seq_len=16, stride=4, **kwargs):
        ...
        self.root = osp.join(root, 'SVReID')
        # print(self.root)
        self.train_path = osp.join(self.root, 'train_svreid_cc.txt')
        self.query_path = osp.join(self.root, 'query.txt')
        self.gallery_path = osp.join(self.root, 'gallery.txt')
        self._check_before_run()
...
class SVReID_plus(object):
    ...
    def __init__(self, root='/data/datasets/', sampling_step=64, seq_len=16, stride=4, **kwargs):
        ...
        self.root = osp.join(root, 'SVReID')
        # print(self.root)
        self.train_path = osp.join(self.root, 'train_svreid_plus.txt')
        self.query_path = osp.join(self.root, 'query.txt')
        self.gallery_path = osp.join(self.root, 'gallery.txt')
        self._check_before_run()
